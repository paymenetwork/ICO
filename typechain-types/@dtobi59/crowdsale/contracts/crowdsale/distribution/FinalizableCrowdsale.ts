...
export interface FinalizableCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface FinalizableCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FinalizableCrowdsaleInterface;
