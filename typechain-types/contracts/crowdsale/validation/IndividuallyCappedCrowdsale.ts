...
export interface IndividuallyCappedCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface IndividuallyCappedCrowdsale extends BaseContract {
