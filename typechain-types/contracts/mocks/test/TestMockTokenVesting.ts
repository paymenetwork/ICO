...
export interface TestMockTokenVestingInterface extends utils.Interface {
  functions: {
...
export interface TestMockTokenVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestMockTokenVestingInterface;
