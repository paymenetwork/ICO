...
export interface TestMockCrowdsaleInterface extends utils.Interface {
  functions: {
...
export interface TestMockCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestMockCrowdsaleInterface;
